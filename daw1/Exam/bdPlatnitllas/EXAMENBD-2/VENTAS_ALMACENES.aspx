<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VENTAS_ALMACENES.aspx.cs" Inherits="VENTAS_ALMACENES" %>
...
<body bgcolor="#bbbb88">
    ...
    <table class="auto-style1">
        ...
        <tr><td class="c1" ><h3><b>Almacen:</b></h3>
            <asp:TextBox ID="txtNombreAlmacen" runat="server" Width="332px"></asp:TextBox> 
              </td>
            <td colspan="2"><h3>Venta</h3>
            </td></tr>
        <tr>
        <td class="c1">
            <asp:DropDownList ID="ddlAlmacenes" runat="server">
            </asp:DropDownList>
        </td>
