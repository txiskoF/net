...
<body style="height: 465px">
    ...
    <asp:Panel ID="pnlAzucar" runat="server" 
        ...
        <asp:RadioButtonList ID="rdbAzucar" runat="server" AutoPostBack="True" 
            onselectedindexchanged="rdbAzucar_SelectedIndexChanged">
    ...
    <p>
        <asp:ImageButton ID="imgTaza" runat="server" ImageUrl="~/IMAGENES/tazacafe.jpg" 
            ...
            style="z-index: 1; left: 584px; top: 190px; position: absolute; height: 208px; width: 273px" 
            onclick="imgTaza_Click" />
    </p>
