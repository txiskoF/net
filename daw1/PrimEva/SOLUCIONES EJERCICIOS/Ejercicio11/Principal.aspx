<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Principal.aspx.cs" Inherits="Ejercicio11.Principal" %>
...
<body>
    ...
    <asp:CheckBoxList ID="chklopcional" runat="server" Font-Names="Arial" 
        ...
        style="z-index: 1; left: 16px; top: 337px; position: absolute; " 
       >
    ...
    <p>
        <asp:Button ID="btnReinicio" runat="server"  
            Text="Reiniciar" OnClick="btnReinicio_Click" />
    </p>
    </div>
    </form>
</body>
