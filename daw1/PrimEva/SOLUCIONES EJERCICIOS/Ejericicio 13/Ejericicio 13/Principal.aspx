<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Principal.aspx.cs" Inherits="Ejericicio_13.Principal" %>
...
<body>
    ...
    <div style="z-index: 1">
        ...
        <asp:TextBox ID="txtelemento" runat="server" AutoPostBack="True"> </asp:TextBox>
        <br />
        <br />
        <br class="style2" />
