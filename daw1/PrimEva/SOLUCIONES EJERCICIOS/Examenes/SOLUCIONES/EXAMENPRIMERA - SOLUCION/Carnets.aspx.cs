...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void txtNombre_TextChanged(object sender, EventArgs e)
    {
        ...
        //actualizo  la ruta a la fotografia con los datos obtenidos
    ...
    protected void limpiarFormulario()
    {
        ...
        foreach (Control elemento in pnlDatosPersonales.Controls)
        {
            ...
            //pongo lo de la viestae en el cuddro txtcodigo
            txtCodigo.Text = ViewState["CodigoCliente"].ToString();
            //pongo a origen la ruta de l fotografia
            txtRutaFotografia.Text = "Imagenes/";
	...
	int cargosMenores,cargosMayores;
        ...
        if (txtCargosMenores.Text != "")
            //cojo el numeor de menores a cargo y lo guardo en variable
            cargosMenores = Convert.ToInt32(txtCargosMenores.Text);
        else
            //si no es que no hay
            cargosMenores = 0;
        //MISMO PROCESO SI HAY MAYORES A CARGO
