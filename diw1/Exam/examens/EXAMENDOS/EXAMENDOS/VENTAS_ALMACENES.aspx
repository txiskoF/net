<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VENTAS_ALMACENES.aspx.cs" Inherits="EXAMENDOS.Pincipal" %>
...
<body bgcolor="#bbbb88">
    ...
    <table class="auto-style1">
        ...
        <tr><td class="c1" ><h3><b>Almacen:</b></h3>
            <asp:TextBox ID="txtNombreAlmacen" runat="server" Width="332px" OnTextChanged="txtNombreAlmacen_TextChanged" AutoPostBack="True"></asp:TextBox> 
              </td>
        ...
        <td class="c1">
            ...
            <asp:DropDownList ID="ddlAlmacenes" runat="server" OnSelectedIndexChanged="ddlAlmacenes_SelectedIndexChanged" AutoPostBack="True">
            </asp:DropDownList>
        </td>
        ...
        <td colspan="2" class="c3" >
         <asp:DropDownList ID="ddlVentas" runat="server" BackColor="White" 
             Font-Bold="True" ForeColor="#666633" Height="16px" 
                Width="227px" OnSelectedIndexChanged="ddlVentas_SelectedIndexChanged" AutoPostBack="true">
        </asp:DropDownList>
        </td>
        ...
        <tr>
        <td class="style7" >
            <asp:ListBox ID="lstLibros" runat="server" Height="101px" Width="387px" OnSelectedIndexChanged="lstLibros_SelectedIndexChanged" AutoPostBack="true">
            </asp:ListBox>
           ...
           <table class="auto-style3">
            ...
            <td class="auto-style5">
                <table class="auto-style4">
                    ...
                    <tr><td class="style6"> <asp:Button ID="btnMostrarDatos" runat="server" Font-Bold="True" ForeColor="#666633" Width="214px" Text="Mostrar Datos" OnClick="btnMostrarDatos_Click" /></td></tr>
      ...
      <tr><td colspan="3">
       ...
       <td class="style8" colspan="3">
           ...
           <asp:Button ID="btnAgregarLOV" runat="server" Text="Insertar nuevo Libro a la Venta" 
                               ...
                               Width="355px" OnClick="btnAgregarLOV_Click"  />
  
    <asp:Button ID="btnBorrarOV" runat="server" Text="Borrar Libro de la Orden de Venta"  
                Font-Bold="True" ForeColor="#666633" Width="408px" OnClick="btnBorrarOV_Click" 
                />
