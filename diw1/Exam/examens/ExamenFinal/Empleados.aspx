    ...
    <table class="auto-style4">
        ...
        <td class="c1" colspan="2">
         <asp:DropDownList ID="ddleditoriales" runat="server" BackColor="White" 
             Font-Bold="True" ForeColor="#666633" Height="16px" 
                Width="227px" AutoPostBack="True" OnSelectedIndexChanged="ddleditoriales_SelectedIndexChanged" >
        </asp:DropDownList>
        ...
        <td class="auto-style6" >
              <table class="auto-style3">
                  ...
                  <tr><td> <asp:ListBox ID="lstEmpleados" runat="server" Height="126px" Width="268px" OnSelectedIndexChanged="lstEmpleados_SelectedIndexChanged" > </asp:ListBox></td></tr>
            </table>
        </td>
        <td rowspan="4" class="auto-style8">
            ...
            <tr><td> <asp:Label ID="LblProfesionesEmp" runat="server" Text="Profesiones:"  Font-Bold="True" ForeColor="#666633"></asp:Label></td></tr>
                 <tr><td><asp:ListBox ID="lstProfesiones" runat="server" Height="105px" Width="183px" OnSelectedIndexChanged="lstProfesiones_SelectedIndexChanged"></asp:ListBox></td></tr>
