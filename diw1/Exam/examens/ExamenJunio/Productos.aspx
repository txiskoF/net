<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Productos.aspx.cs" Inherits="ExamenJunio.Productos" %>
            ...
            <asp:TextBox ID="txtidcat" runat="server" 
                ...
                <td class="style17">
                    <asp:Button ID="btnbuscar" runat="server" Text="Buscar" 
                        ...
                        TabIndex="1" Width="144px" style="margin-left: 0px" OnClick="btnbuscar_Click" /></td>
                <td>
