<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DESCONECTADO.aspx.cs" Inherits="DESCONECTADO" %>
...
<body bgcolor="#999966">
    ...
    <table><tr><td>
        ...
        <tr><td colspan="3" align="right">
          <asp:ListBox ID="lstdatospedido" runat="server" Font-Bold="True" 
                ForeColor="#666633" Width="257px"></asp:ListBox>
           </td>
           </tr>
           <tr><td colspan="3" align="right">
