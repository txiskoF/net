...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <asp:Button ID="btn4" runat="server" Text="4%" CommandArgument="0,04" CommandName="4%" OnCommand="Calcular" EnableTheming="False" CssClass="auto-style10" />
        ...
        <asp:Button ID="btnh1" runat="server" Text="H1" CommandArgument="&lt;/H1&gt;" CommandName="&lt;H1&gt;" CssClass="auto-style9" OnCommand="Marcar"   />
            ...
            <asp:Button ID="btnh3" runat="server" Text="H3" CommandArgument="&lt;/H3&gt;" CommandName="&lt;H3&gt;" CssClass="auto-style8" height="29px"  width="34px" OnCommand="Marcar" />
