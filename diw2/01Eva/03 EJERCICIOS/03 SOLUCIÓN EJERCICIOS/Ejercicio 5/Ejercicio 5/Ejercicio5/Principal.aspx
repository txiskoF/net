...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <asp:TextBox ID="txtcantidad" runat="server" style="z-index: 1; left: 97px; top: 26px; position: absolute" AutoPostBack="True" ></asp:TextBox>
        ...
        <asp:Button ID="btnh1" runat="server" style="z-index: 1; left: 27px; top: 211px; position: absolute" Text="H1" OnCommand="Marcar"/>
    
   
      
            <asp:Button ID="btnh2" runat="server" Text="H2" CssClass="auto-style3" height="29px" width="34px" OnCommand="Marcar" />
       
            <asp:Button ID="btnh3" runat="server" Text="H3" CssClass="auto-style4" height="29px" width="34px" OnCommand="Marcar" />
                 
            <asp:Button ID="btnh4" runat="server" Text="H4" CssClass="auto-style5" height="29px" width="34px" OnCommand="Marcar" />
              
           <asp:Button ID="btnh5" runat="server" Text="H5" CssClass="auto-style6" height="29px" width="34px" OnCommand="Marcar"/>
                    
           <asp:Button ID="btnh6" runat="server" Text="H6" CssClass="auto-style7" height="29px" width="34px" OnCommand="Marcar" />
          </asp:Panel>
