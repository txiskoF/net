...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PRINCIPAL_PEDIDOS.aspx.cs" Inherits="PRINCIPAL_PEDIDOS" %>
...
<body bgcolor="#bbbb88">
           ...
           <tr>
            ...
            <tr>
                ...
                <asp:Button ID="btnAñadir"  runat="server" Font-Bold="True" ForeColor="#666633" 
                    Text="Añadir al Pedido" Width="138px" />
                </td>
             </tr>
             <tr>
    ...
    <asp:Button ID="btnGenerarPedido" runat="server" Text="Generar Pedido"  
                Font-Bold="True" ForeColor="#666633" Width="185px" />
  
              </td>

       <td class="style6">
           <asp:Button ID="btnBorrarPedido" runat="server" Text="Borrar Pedido"  
               Font-Bold="True" ForeColor="#666633" Width="211px"/>
