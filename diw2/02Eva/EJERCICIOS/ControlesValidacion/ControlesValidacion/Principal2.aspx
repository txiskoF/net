<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Principal2.aspx.cs" Inherits="ControlesValidacion.Principal2" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtCorreo" ErrorMessage="RegularExpressionValidator" ValidationExpression="\w+@(zabal|zabalburu).net"></asp:RegularExpressionValidator>
            <br />
