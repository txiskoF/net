<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Principal.aspx.cs" Inherits="EcamenDOS.Principal" %>
    ...
    <div style="height: 371px">
        ...
        <br />
          <asp:Label ID="Label1" runat="server" Text="Nombre Empleado: "></asp:Label>
            <asp:TextBox ID="txtnombreE" runat="server" CssClass ="textos" OnTextChanged="txtnombreE_TextChanged" 
              ></asp:TextBox>
        <br />
        <asp:Label ID="Label3" runat="server" Text="Departamento: "></asp:Label>
            <asp:TextBox ID="txtdpto" runat="server" CssClass ="textos" AutoPostBack="True" OnTextChanged="txtdpto_TextChanged" 
               ></asp:TextBox>
        <br />
        ...
        <asp:ImageButton ID="imgbsueldo" runat="server" Height="94px" Width="172px" 
                 CssClass="imagen" OnClick="imgbsueldo_Click"  />
       <div>
        <asp:Panel ID="pnlpuesto" runat="server" CssClass ="panel" 
              GroupingText="Puesto de Trabajo">
               
              
            <asp:RadioButtonList ID="rdblpuesto" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rdblpuesto_SelectedIndexChanged" 
               >
           ...
           <div>
            <asp:CheckBoxList ID="chklextras" runat="server" CssClass="extras" 
             ...
             <asp:Button ID="btnreiniciar" runat="server" Text="Reiniciar" 
                CssClass="imagen" Width="300" OnClick="btnreiniciar_Click"/>
