...
namespace SOLUCION_Ejercicio1
{
    public partial class PEDIDOS_A_CLIENTES : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //de inicio cargo esto llamando al metodo
