...
<body>
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:RegularExpressionValidator ID="reDNI" runat="server" ErrorMessage="El DNI no cumple con el formato adecuado" ValidationExpression="(\d{8}[A-Z]|\d{2}\s\d{3}\ \d{3}[A-Z]|\d{2}\.\{3}\.\d{3}\-[A-Z])" ControlToValidate="txtDNI" Display="Dynamic" ValidationGroup="a"></asp:RegularExpressionValidator>
            </td>
            <td>
                <asp:CustomValidator ID="cvdni" runat="server" ErrorMessage="La letra no corresponde al DNI especificado" ClientValidationFunction="validarDNI" ControlToValidate="txtDNI" ValidationGroup="a" ></asp:CustomValidator>
            </td>
        </tr>
         <tr>
            <td><b>Nombre:</b></td>
